...
@section('title', '利用規約 | TYPOGRA タイポグラ | 作字・タイポグラフィ投稿サイト')

@section('content')
<div class="page-type2">
    @include('common-parts.header-logo')
    <div class="page-type2__inner page-type2__inner--2 mt30">
    <h1 class="page-type2__title mb20">利用規約</h1>

    <p>この利用規約（以下，「本規約」といいます。）は，本ウェブサイトの運営管理者（以下，「当方」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>

    <h2>第<span class="auto-num"></span>条（適用）</h2>
    <ol>
    ...
    <h2>第<span class="auto-num"></span>条（利用登録）</h2>
    <ol>
    ...
    <h2>第<span class="auto-num"></span>条（ユーザーIDおよびパスワードの管理）</h2>
    <ol>
    ...
    <!-- <h2>第<span class="auto-num"></span>条（利用料金および支払方法）</h2>
    <ol>
    ...
    <h2>第<span class="auto-num"></span>条（禁止事項）</h2>
    ...
    <ol>
      ...
      <li>以下の表現を含み，または含むと当方が判断する内容を本サービス上に投稿し，または送信する行為
        <ol>
          <li>過度に暴力的な表現</li>
          <li>露骨な性的表現</li>
    ...
    <h2>第<span class="auto-num"></span>条（本サービスの提供の停止等）</h2>
    <ol>
    ...
    <h2>第<span class="auto-num"></span>条（著作権）</h2>
    <ol>
    ...
    <h2>第<span class="auto-num"></span>条（利用制限および登録抹消）</h2>
    <ol>
      <li>当方は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，投稿データを削除し，ユーザーに対して本サービスの全部もしくは一部の利用を制限しまたはユーザーとしての登録を抹消することができるものとします。
        <ol>
      ...
      <li>前項各号のいずれかに該当した場合，ユーザーは，当然に当方に対する一切の債務について期限の利益を失い，その時点において負担する一切の債務を直ちに一括して弁済しなければなりません。</li>
      <li>当方は，本条に基づき当方が行った行為によりユーザーに生じた損害について，一切の責任を負いません。</li>
    </ol>

    <h2>第<span class="auto-num"></span>条（退会）</h2>
    <p>ユーザーは，当方の定める退会手続により，本サービスから退会できるものとします。</p>

    <h2>第<span class="auto-num"></span>条（保証の否認および免責事項）</h2>
    <ol>
    ...
    <h2><span class="auto-num"></span>条（サービス内容の変更等）</h2>
    <p>当方は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>

    <h2><span class="auto-num"></span>条（利用規約の変更）</h2>
    <ol>
    ...
    <h2>第<span class="auto-num"></span>条（個人情報の取扱い）</h2>
    <p>当方は，本サービスの利用によって取得する個人情報については，当方「<a href="{{ route('privacy-policy') }}">プライバシーポリシー</a>」に従い適切に取り扱うものとします。</p>

    <h2>第<span class="auto-num"></span>条（通知または連絡）</h2>
    ...
    <h2>第<span class="auto-num"></span>条（権利義務の譲渡の禁止）</h2>
    <p>ユーザーは，当方の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>

    <h2>第<span class="auto-num"></span>条（準拠法・裁判管轄）</h2>
    <ol>
