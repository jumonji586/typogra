  ...
  <div class="page-type2__inner mt30">
    ...
    <form method="POST" action="{{ route('register') }}">
      ...
      <div class="page-type2__item-name rule-privacy-box">
        <input class="page-type2__checkbox" type="checkbox" name="rule-privacy"><p><a href="" class="fw-b underline" target="_blank">利用規約</a> および <a href="" class="fw-b underline" target="_blank">プライバシーポリシー</a> に同意する</p>
      </div>
